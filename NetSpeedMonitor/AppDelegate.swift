...
//        }
        if let button = statusItem.button {
            button.attributedTitle = NSAttributedString(string: "\n\(String(format: "%5.2lf", uploadSpeed)) \(uploadMetric)/s ↑\n\(String(format: "%5.2lf", downloadSpeed)) \(downloadMetric)/s ↓", attributes: statusBarTextAttributes)
        }
...
//        }
        if let button = statusItem.button {
            button.attributedTitle = NSAttributedString(string: "\n\(String(format: "%5.2lf", 0.0)) KB/s ↑ \n\(String(format: "%5.2lf", 0.0)) KB/s ↓", attributes: statusBarTextAttributes)
        }
